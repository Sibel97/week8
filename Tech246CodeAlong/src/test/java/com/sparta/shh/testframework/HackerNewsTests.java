package com.sparta.shh.testframework;

import com.sparta.shh.testframework.lib.pages.CommentsPage;
...
//         pastLink.click();
    ...
    public void checkCommentLink() {
        ...
        // Assert
        MatcherAssert.assertThat(commentsPage.getUrl(), is("https://news.ycombinator.com/newcomments"));
